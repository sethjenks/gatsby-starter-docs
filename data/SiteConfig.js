module.exports = {
  ...
  userTwitter: "navdesignteam", // Optionally renders "Follow Me" in the UserInfo segment.
  userLocation: "Draper, UT", // User location to display in the author segment.
  ...
  userLinks: [
    ...
    {
      label: "Instagram",
      url: "https://instagram.com/navdesignteam",
      iconClassName: "fa fa-envelope"
    }
  ],
